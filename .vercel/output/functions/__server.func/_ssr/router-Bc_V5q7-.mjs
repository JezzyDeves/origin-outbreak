...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bc_V5q7-.js
var router_Bc_V5q7__exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-BoirqzqH.css";
var APP_NAME = "Origin";
var Route$4 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Design a pathogen and watch it move across the United States."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-C5ISLaDR.mjs");
var Route$3 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-CJYNFD5g.mjs");
...
//#endregion
export { router_Bc_V5q7__exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
